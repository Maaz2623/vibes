  ...
  return (
    <button
      className={cn(
        ...
        isActiveFragment &&
          "bg-primary dark:text-black text-white border-primary hover:bg-primary"
      )}
...
const UserMessage = ({ content }: UserMessageProps) => {
  return (
    <div className="flex justify-end pb-4 pr-2 pl-10">
      <Card className="rounded-lg dark:text-muted bg-gray-300 p-3 shadow-none border-none max-w-[80%] break-words">
        {content}
      </Card>
    </div>
  );
